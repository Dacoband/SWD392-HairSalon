...
const ManagerAppointments = () => {
  ...
  >({})
  const [cancellations, setCancellations] = useState<Record<string, string>>({}) // Map of appointmentId to reason
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (appointmentId: string) => (<span>{cancellations[appointmentId] || 'N/A'}</span>
      ),
    },
  ]
